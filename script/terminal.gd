...
func makeNewLine(input: String):
	...
	replaceInputText.position = Vector2(currTerminalTitle.position.x + 28, currTerminalTitle.position.y)
	...
	newTerminalTitle.position = Vector2(currTerminalTitle.position.x, currTerminalTitle.position.y + 20)
